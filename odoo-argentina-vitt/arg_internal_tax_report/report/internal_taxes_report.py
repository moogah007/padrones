...
class InternalTaxesReport(models.AbstractModel):
    _name = 'report.vitt_arg_internal_tax_report.report_internal_taxes'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('vitt_arg_internal_tax_report.report_internal_taxes', docargs)
